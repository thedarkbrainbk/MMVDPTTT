...
if __name__ == "__main__":
    ...
    message = input("Nhập chuỗi để tính giá trị hash SHA-256: ")

    # Tính toán và in ra giá trị hash SHA-256 của chuỗi đã nhập
    hash_value = generate_hash(message.encode('utf-8'))
